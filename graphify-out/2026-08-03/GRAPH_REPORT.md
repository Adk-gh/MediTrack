# Graph Report - MediTrack  (2026-08-03)

## Corpus Check
- 191 files · ~244,673 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1659 nodes · 2211 edges · 151 communities (113 shown, 38 thin omitted)
...
Cohesion: 0.12
Nodes (14): jspdf, DentalExaminationReport(), DentalNotesTextarea, TextInput, DoctorTextarea, MedicalCertificate(), RemarksTextarea, Approvals() (+6 more)
...
Cohesion: 0.05
Nodes (40): cors, dotenv, express, form-data, jsonwebtoken, multer, nodemailer, author (+32 more)
...
Cohesion: 0.11
Nodes (18): addDataRow(), addSectionHeader(), addTableHeader(), addTitleBanner(), applyPercentFormat(), DENTAL_CONDITIONS, getSchoolYear(), IconActivity() (+10 more)
...
Cohesion: 0.10
Nodes (27): buildFullAddress(), calcAge(), CIVIL_STATUSES, departmentsData, deptAbbrToFull, EMERGENCY_RELATIONSHIPS, getCitiesByProvince(), getDefaultClassification() (+19 more)
...
Cohesion: 0.10
Nodes (5): MobileHeader(), DashboardLayout(), DEFAULT_MOBILE_NAV, getStoredUserRole(), ROLE_MOBILE_NAV
...
Cohesion: 0.10
Nodes (6): DEFAULT_MOBILE_ITEMS, DENTAL_PROCEDURES, DesktopNav(), getStoredUserRole(), ROLE_MOBILE_NAV_CONFIG, ROLE_NAV_CONFIG
...
### Community 20 - "UserDashboardLayout.jsx"
Cohesion: 0.05
Nodes (21): formatTimeAgo(), getNotificationIcon(), NotificationBell(), NotificationPanel(), formatTimeAgo(), getNotificationIcon(), UserNotificationBell(), UserNotificationPanel() (+13 more)
...
Cohesion: 0.13
Nodes (15): @capacitor/android, @emotion/react, @emotion/styled, dependencies, axios, @capacitor/android, @emotion/react, @emotion/styled (+7 more)
...
Cohesion: 0.21
Nodes (11): AnnouncementCard(), AnnouncementModal(), CATEGORY_COLORS, formatApptTime(), formatDate(), HEALTH_TIPS, HomePageUsers(), HOUR_SLOTS (+3 more)
...
### Community 45 - "Technologies Not Yet Implemented"
Cohesion: 0.05
Nodes (38): Backend (Node.js + Express), CI/CD, Currently Used Packages, Currently Used Packages, Currently Used Packages (Dependencies), Currently Used Packages (DevDependencies), Database (Offline Mode), Desktop Application (+30 more)
...
Cohesion: 0.29
Nodes (7): ALL_YEARS, buildDays(), DatePicker(), getDaysInMonth(), MONTH_FULL, MONTHS, parseDateValue()

### Community 51 - "auth.service.js"
Cohesion: 0.19
Nodes (9): DEFAULT_STEPS, LoadingAnimation(), SignupForm(), checkIdExists(), getAuthHeaders(), getProfile(), login(), register() (+1 more)
...
### Community 65 - "DesktopHeader"
Cohesion: 0.25
Nodes (7): AdminLayoutWrapper(), App(), DesktopHeader(), Dashboard(), root, getCurrentUser(), logout()
...
### Community 121 - "AppointmentManagement.jsx"
Cohesion: 0.19
Nodes (17): AppointmentManagement(), CLINIC_SLOTS, formatDate(), formatTime(), fromDateInputValue(), SORT_OPTIONS, STATUS_OPTIONS, toDateInputValue() (+9 more)
...
### Community 136 - "react"
Cohesion: 0.40
Nodes (5): react, DentalHistoryDrawerSection(), emptyDentalHistory(), ProfileDrawer(), react
...
## Knowledge Gaps
- **673 isolated node(s):** `express`, `globalErr`, `routes`, `cors`, `app` (+668 more)
...
- **Why does `dependencies` connect `dependencies` to `src/supabase.js`, `Record-Management.jsx`, `zod`, `devDependencies`, `react`, `@capacitor/ios`, `chart.js`, `date-fns`, `file-saver`, `exceljs`, `react-chartjs-2`, `yup`, `@capacitor/core`, `html2canvas`, `@ionic/react`, `lucide-react`, `react-router-dom`, `vite-plugin-compression`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `supabase` connect `src/supabase.js` to `Consultations.jsx`, `Profile-users.jsx`, `ApprovalManagement.jsx`, `Records.jsx`, `Dental.jsx`, `User-Management.jsx`, `Appointments.jsx`, `Medical.jsx`, `Headers.jsx`, `UserDashboardLayout.jsx`, `Consultation-users.jsx`, `Announcements.jsx`, `token.service.js`, `Record-Management.jsx`, `homepage-users.jsx`, `Records-users.jsx`, `auth.service.js`, `Appointment-users.jsx`, `services/announcements.service.js`, `AppointmentContext.jsx`, `Examinations.jsx`, `AppointmentManagement.jsx`, `AuditLogs.jsx`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `Consultations.jsx`, `dependencies`, `DashboardLayout.jsx`?**
