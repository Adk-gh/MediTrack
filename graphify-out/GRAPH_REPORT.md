...
Cohesion: 0.10
Nodes (17): addDataRow(), addSectionHeader(), addTableHeader(), addTitleBanner(), applyPercentFormat(), DENTAL_CONDITIONS, getSchoolYear(), IconActivity() (+9 more)
...
Cohesion: 0.11
Nodes (21): CLASSIFICATION_MAP, classificationColors, CLINIC_ROLES, CreateUserModal(), currentUser, departmentsData, deptAbbrToFull, FACULTY_ROLES (+13 more)
...
Cohesion: 0.09
Nodes (8): DEFAULT_MOBILE_ITEMS, DENTAL_PROCEDURES, DesktopNav(), getStoredUserRole(), parseJsonIfNeeded(), ROLE_MOBILE_NAV_CONFIG, ROLE_NAV_CONFIG, withProfileDefaults()
...
Cohesion: 0.18
Nodes (11): DEFAULT_STEPS, LoadingAnimation(), LoginForm(), SignupForm(), validateEmailWithEasyEmail(), checkIdExists(), getAuthHeaders(), getProfile() (+3 more)

### Community 153 - "src/supabase.js"
Cohesion: 0.18
Nodes (3): UserNotificationBell(), ARCHIVE_TYPE_LABELS, supabase
