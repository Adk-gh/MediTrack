      ...
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .m-spinner {
            ...
            border: 3px solid #E8EDEC; border-top-color: #2D5C52;
            ...
            {!isReady && !error ? (
              <div style={{ textAlign: 'center', padding: '20px' }}>
                <div style={{
                  ...
                  borderRadius: '50%', animation: 'rp-spin 1s linear infinite',
                  margin: '0 auto 16px'
                }} />
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <Link
                  to="/forgot-password"
                  style={{
                    display: 'inline-block', padding: '12px 24px', background: '#466460',
                    color: 'white', textDecoration: 'none', borderRadius: 8, fontWeight: 600
                  }}
                >
        ...
        <div className="m-card">
          {!isReady && !error ? (
            <div className="m-spinner-wrap">
              ...
              <p className="m-spinner-text">Preparing reset link...</p>
            </div>
          ) : error && !isReady ? (
            <div>
              ...
              <p style={{ color: '#8AA09C', fontSize: 13.5, marginBottom: 20, textAlign: 'center' }}>
                The reset link has expired or is invalid. Please request a new one.
              </p>
              <Link to="/forgot-password" className="m-btn-ghost">
                Request New Reset Link
              </Link>
            </div>
          ) : (
